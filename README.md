...
1. It's a framework, one of it's application is routing
2. It uses middleware to add extra functionality to our application
...
By making use of express router, we can break it down into different parts.
